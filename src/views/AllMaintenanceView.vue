        ...
        >
          ...
          <div class="card-body">
            <div class="card-content">
              ...
              <span class="badge bg-secondary m-2" v-if="item.electricity"
                >كهرباء</span
              >
              <span class="badge bg-success m-2" v-if="item.painting"
                >دهان و سمكره</span
              >
              <span class="badge bg-danger m-2" v-if="item.mechanics"
                >ميكانيكا</span
              >
              <span class="badge bg-warning text-dark m-2" v-if="item.singular"
                >عقشه</span
              >
            </div>
          </div>
...
const maintenanceData = reactive([] as any[]);
